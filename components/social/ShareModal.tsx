...
export default function ShareModal({ inviteUrl, onClose }: ShareModalProps) {
    ...
    const shareText = "Join me on Consistency - the gamified habit tracking app! 🎯";
    ...
    const handleEmail = () => {
        const subject = "Join me on Consistency!";
        ...
        >
            ...
            >
                ...
                <div className={styles.header}>
                    <h2 className={styles.title}>Share Invite</h2>
                    <p className={styles.subtitle}>Choose how to share your invite link</p>
                </div>

                <div className={styles.shareButtons}>
                    <button className={styles.shareButton} onClick={handleWhatsApp}>
                        <WhatsAppIcon />
                        <span>WhatsApp</span>
                    </button>
                    <button className={styles.shareButton} onClick={handleTelegram}>
                        <TelegramIcon />
                        <span>Telegram</span>
                    </button>
                    <button className={styles.shareButton} onClick={handleX}>
                        <XIcon />
                        <span>X (Twitter)</span>
                    </button>
